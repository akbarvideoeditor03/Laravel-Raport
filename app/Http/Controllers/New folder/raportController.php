...
class raportController extends Controller
{
    ...
    public function create()
    {
        ...
        $data['cara'] = 'post';
        $data['judul'] = 'Tambah Daftar Raport Siswa';
        $data['tombol'] = 'Simpan';
    ...
    public function store(Request $request)
    {
        ...
        $nilai->kode_nilai_mapel = $request->kode_nilai_mapel;
    ...
    {
        $siswa = \App\Models\raports::where('nisn', $nisn)->first();
        $data['rapors'] = $siswa;

        $absen = \App\Models\absens::where('nisn', $nisn)->get();
        $data['absensi'] = $absen;

        $nilai = \App\Models\nilai_mapels::where('nisn', $nisn)->orderBy('kode_mapel')->get();
        $data['nila'] = $nilai;
     ...
     */
    public function destroy(string $nomor_raport)
    {
        //
    }
}
