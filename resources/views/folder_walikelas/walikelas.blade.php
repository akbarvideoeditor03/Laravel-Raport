...
@section('ahmad_akbar')
<div class="card" id="efekblur">
    <div class="card-header teksjudul">
        {{ $tittle }}
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-xl-3">
                <a href="/walikelas10/create" class="btn btn-primary" style="width: 100%">Tambah Data</a>
            </div>
            <div class="col-xl-3">
                <a href="/walasalamat" class="btn btn-primary" style="width: 100%" target="blank">Daftar Alamat Wali Kelas</a>
            </div>
            <div class="col-xl-6">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <h6 style="color: white">Gambar Tanda Tangan :</h6>
